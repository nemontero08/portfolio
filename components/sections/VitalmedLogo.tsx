...
export default function VitalmedLogo({
  height = 20,
  className,
}: {
  height?: number;
  /** Lets a caller's own CSS override `height` at specific breakpoints (with !important — see Hero.module.css's tablet block) without this component needing to know about them itself. */
  className?: string;
}) {
  return (
    <svg
      viewBox="0 0 177.354 24.6"
